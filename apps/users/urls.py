...
urlpatterns = [
    path('accounts/seller/registration', CustomerCreateAPIView.as_view(), name='sign-up'),
    path('accounts/login', SignInView.as_view(), name='sign-in'),
    path('accounts/me', ProfileAPIView.as_view(), name='sign-in'),
